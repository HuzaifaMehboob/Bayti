...
const AgentProfileHeroSection = () => {
  ...
  return (
    <div className='relative h-[600px]'>
      ...
      <div
        className='absolute bottom-20 left-20 max-w-fit bg-white shadow-lg rounded-xl px-6 py-4 space-y-3'
        dir="ltr"
      >
      ...
      <div className='absolute right-20 bottom-0 translate-y-1/2 w-[200px] h-[200px] rounded-full bg-[#F9F9F9] shadow-md flex items-center justify-center'>
